...
public class Estado implements Comparable{
    ...
    public ArrayList<Estado> getTransicaoPorAlfa(String alfa) {
        int i = 0;
    ...
    public void setAutomatoPertencente(Automato a){
        this.automato = a;
    }
    ...
    public Automato getAutomatoPertencente() {
        return this.automato;
    }
    
    public Automato getAutomatoOriginal(){
        return this.automatoPai;
    }
